...
#define STRING_VERSION_CONFIG_H __DATE__ "16/03/18 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Shiul93" // Who made the changes.#define SHOW_BOOTSCREEN
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80*2,80*2,2560*2,830}  // default steps per unit for Ultimaker
/**
...
/**
 * Z   Probe, such as an endstop switch on a rotating arm.
 */
